...
package com.seeyii.flink.cdc.clickhouse.internal.options;
...
public class ClickHouseConnectionOptions implements Serializable {
    ...
    public ClickHouseConnectionOptions(
            String url,
    ...
    public String getUrlSuffix() {
        ...
        database = isNullOrWhitespaceOnly(database) ? "" : "/" + database;
        param = isNullOrWhitespaceOnly(param) ? "" : "?" + param;
